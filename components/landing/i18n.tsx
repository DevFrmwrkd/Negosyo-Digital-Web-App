...
const EN: Dict = {
    ...
    "price.stdF6": "Free edits for the first year — ask us, we make the change",
...
const TL: Dict = {
    ...
    "price.stdF6": "Libreng edits sa loob ng unang taon — sabihin mo lang, kami na ang magpapalit",
